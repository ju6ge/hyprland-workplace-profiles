use std::{path::PathBuf, collections::{BTreeMap, HashMap}, fmt::format};

use clap::{Parser, builder};
use derive_builder::Builder;
use serde::{Serialize, Deserialize};
use wayland_client::{Connection, Dispatch, protocol::{wl_registry, wl_display::WlDisplay, wl_output::Transform}, Proxy, event_created_child, backend::{ObjectData, ObjectId}};
use wayland_protocols_wlr::output_management::v1::client::{*, zwlr_output_configuration_v1::ZwlrOutputConfigurationV1, zwlr_output_head_v1::{ZwlrOutputHeadV1, AdaptiveSyncState}, zwlr_output_mode_v1::ZwlrOutputModeV1};
...
async fn main() {
    ...
    println!("{:#?}", state.current_configuration)
}
